...
/** A job's execution state — a thin preset over Foundation Feedback's own StatusIndicator, the same pattern Status & Health's own HealthIndicator and Bulk Actions' own BulkStatus already established for their own state vocabularies. */
