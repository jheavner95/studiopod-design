 ...
 */
export function CommandNavigation({ items, placeholder, shortcutKey = "k", className }: CommandNavigationProps) {
  ...
  return (
    <>
      <button
        ...
        className={cn(
          "focus-ring flex items-center gap-2 rounded-md border border-border bg-surface px-3 py-1.5 text-caption text-ink-tertiary transition-colors duration-[var(--duration-fast)] ease-[var(--ease-standard)] hover:text-ink-primary",
          className,
        )}
      >
