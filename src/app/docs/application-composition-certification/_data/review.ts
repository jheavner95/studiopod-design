...
export const VERIFY_DIMENSIONS: VerifyDimension[] = [
  ...
  { dimension: "Naming", verdict: "Pass", finding: "Zero collisions found — a direct grep for every ProductionFeature* component name against the rest of src/components/ returns no matches, unlike Platform Certification's own disclosed ProductionPipeline collision one tier down." },
