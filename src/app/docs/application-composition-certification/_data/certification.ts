...
export const CERTIFICATION_JUSTIFICATION = [
  ...
  "Enterprise Certified is not reachable regardless of the above: real production adoption evidence does not exist. The pilot is explicitly non-production by its own defined scope (mock data, local state, no real repositories or APIs) — not a genuinely production Business Feature.",
];
