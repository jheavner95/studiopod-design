...
export const ACCESSIBILITY_STRENGTHS: AccessibilityFinding[] = [
  { label: "Keyboard navigation", text: "Every interactive element in the pilot — artwork rows, Tabs, dialog buttons, Undo/Redo — is reachable and operable by keyboard alone, manually verified via Tab-through in the pilot's own browser QA." },
  ...
  { label: "Responsive behavior", text: "Desktop, tablet, and mobile were all manually verified with zero horizontal overflow in the pilot's own QA — the sidebar correctly collapses below the lg breakpoint, and the Dashboard view's metrics fixed from 4 to 2 columns during that same pass." },
];
