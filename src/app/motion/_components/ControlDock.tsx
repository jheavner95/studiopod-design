 ...
 * Reduced Motion/Diagnostics state at once. Bottom-anchored via the shared
 * ControlDockShell so it stays reachable while scrolling without ever
 * moving underneath the persistent top-anchored GlobalNav.
 */
