...
export const STEPPER_FUTURE_EXTENSIONS: StepperFutureExtension[] = [
  ...
  { title: "Conditional steps", description: "Showing or hiding a step based on an earlier answer (e.g. skip the \"business details\" step for an individual account) — deferred until a real wizard needs it; WorkflowStepperStep's own Skipped state covers the display, not the branching logic that would decide it." },
  ...
  { title: "Reusable templates", description: "Saving a stage/step arrangement as a named, reusable wizard definition — a data-layer concern above this package's own stateless, prop-driven components, the same deferral Workflow Framework's own future-extensions already made for its own templates." },
  ...
  { title: "AI-guided workflows", description: "Suggesting or auto-advancing steps based on context rather than a screen hand-composing WorkflowStepper/WorkflowStepperStep itself — deferred pending real usage." },
];
