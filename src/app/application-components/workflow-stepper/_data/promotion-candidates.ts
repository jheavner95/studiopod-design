...
export const STEPPER_CLEAN_FINDINGS: string[] = [
  ...
  "Planning: no src/planning/ directory or component exists anywhere in the repo (re-confirmed from the DS-3.1 audit) — \"Planning\" only appears as an architecture-diagram node label or prose reference.",
