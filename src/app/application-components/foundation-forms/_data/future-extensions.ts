...
export const FORM_FUTURE_EXTENSIONS: FormFutureExtension[] = [
  ...
  { title: "Conditional fields", description: "A field's visibility or requiredness driven by another field's value — needs a small rules engine PropertyEditor doesn't own." },
