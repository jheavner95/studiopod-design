...
/** The five-tier x four-dimension enterprise architecture scorecard, built on Foundation Table directly — the same primitive every other tier's own certification scorecard already composes from. */
export function Scorecard() {
  return (
    <Table caption="Enterprise Architecture & Adoption Audit scorecard, five tiers by four verification dimensions" minWidth="900px">
      <TableHeader>
        <TableRow>
