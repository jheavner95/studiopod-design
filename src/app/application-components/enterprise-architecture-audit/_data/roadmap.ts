...
export const ENTERPRISE_ROADMAP: RoadmapStage[] = [
  ...
  { id: "ds-6-5", title: "DS-6.5 — Final Enterprise Certification", description: "The terminal milestone: the formal system-wide Enterprise Certified sign-off this audit deliberately does not perform. Not yet built.", status: "future" },
];
