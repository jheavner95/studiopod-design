...
export const READINESS_ASSESSMENT: ReadinessRow[] = [
  ...
  { label: "Production-scale adoption evidence", verdict: "Not ready", note: "Zero production Business Features exist anywhere in the codebase. This is the single blocker to the system-wide Enterprise certification, not a defect in the architecture itself." },
];
