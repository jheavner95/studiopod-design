...
export const ADMIN_FUTURE_EXTENSIONS: AdminFutureExtension[] = [
  ...
  { title: "Audit analytics", description: "Trend analysis and historical reporting across AdminAudit's own action log — belongs to the Intelligence platform template (DS-4.1's own architecture), not this one; deferred here rather than duplicated." },
