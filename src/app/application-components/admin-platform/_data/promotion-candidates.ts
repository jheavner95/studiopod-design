...
export const ADMIN_CLEAN_FINDINGS: string[] = [
  ...
  "Enrollment/Governance: does not exist. A repo-wide search for \"enroll\" returns zero hits of any kind — no prose, no code, no fixture. The only \"governance\" hits describe this design system's own DS-1.9 architectural-governance documentation (how the design system's own architecture is allowed to change), unrelated to an Admin platform's tenant/access governance.",
];
