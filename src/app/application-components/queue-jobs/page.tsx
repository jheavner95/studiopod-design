...
function CrossLinks() {
  const links = [
    ...
    { label: "Bulk Actions System", href: "/application-components/bulk-actions" },
  ...
  return (
    <PageShell background={<SystemGrid />}>
      <SectionShell spacing="xl">
        <PageIntro
          eyebrow="package · application components · queue & jobs"
          title="Queue & job components"
          description="The canonical StudioPOD Queue & Job System — the standard operational execution interface for every queued workflow across StudioPOD. Composes Foundation Table/Metadata/Feedback/Navigation end to end, and Operational Data Grid, Bulk Actions, and Status & Health directly, rather than duplicating any of them. Built in DS-2.5.8; not yet adopted by any real screen."
        >
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Badge tone="warning" size="sm" className="w-fit">
              Production Ready — DS-2.5.8
            </Badge>
          </div>
          <div className="pt-2">
            <CrossLinks />
      ...
      <SectionShell spacing="lg" divider>
        <div className="flex flex-col gap-10">
          <SectionHeader
            eyebrow={<Eyebrow tone="accent">Queue anatomy</Eyebrow>}
      ...
      <SectionShell spacing="lg" divider>
        <div className="flex flex-col gap-10">
          <SectionHeader
            ...
            title="Eight queue patterns, live"
        ...
        <div className="flex flex-col gap-10">
          ...
          {QUEUE_PROMOTION_CANDIDATES.length === 0 ? (
            <Card className="flex flex-col gap-2 border-success/30 bg-success-soft">
              ...
              <Body size="sm" muted>
                No existing hand-rolled job-queue UI was found anywhere in the codebase across all five named domains, including a direct read of the Workflow Diagram Library&rsquo;s own WorkflowCard/WorkflowProgress/WorkflowTimeline components. See the clean findings below for what was actually checked.
              </Body>
            </Card>
          ) : null}
