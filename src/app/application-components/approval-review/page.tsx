...
function CrossLinks() {
  const links = [
    ...
    { label: "Foundation Forms System", href: "/application-components/foundation-forms" },
    ...
    { label: "Workflow Stepper", href: "/application-components/workflow-stepper" },
  ...
  return (
    <PageShell background={<SystemGrid />}>
      <SectionShell spacing="xl">
        <PageIntro
          eyebrow="package · application components · approval & review"
          title="Approval & review"
          description="The canonical StudioPOD Approval & Review System — the standard approval workflow used throughout Production, Publishing, Commerce, Planning, and Intelligence, composing the Workflow Framework, Workflow Stepper, Workflow Timeline, and Operational Inspector Panel directly rather than duplicating any of them. Built in DS-3.4, the fourth package of the Workflow Component Library; not yet adopted by any real screen."
        >
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Badge tone="warning" size="sm" className="w-fit">
              Production Ready — DS-3.4
            </Badge>
          </div>
          <div className="pt-2">
            <CrossLinks />
