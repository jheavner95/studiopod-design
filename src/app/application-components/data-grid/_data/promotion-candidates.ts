...
export const GRID_CLEAN_FINDINGS: string[] = [
  "Publishing Queue: every hit is copy/documentation (Foundation Table's and Foundation Layout's own prose, a bare QueueTableDemo inside Foundation Table's own gallery). The component inventory lists \"Queue Table\" as status: \"Needed\" — aspirational, nothing built.",
  ...
  "Inventory: InventoryTable.tsx (82 lines) is real, but is a static hand-rolled div-grid of component inventory metadata rows (component/purpose/status/source/priority) — documentation UI with zero search/filter/selection/pagination, unrelated to a business \"inventory\" domain, and already tracked (not migratable — see Foundation Table's own certification note on its confirmed responsive gap).",
  ...
  "The component inventory and the Foundation Component Catalog both mention \"Queue Table\"/\"Library Table\" only as forward-looking reuseTargets text on other components — neither names a component that actually exists.",
];
