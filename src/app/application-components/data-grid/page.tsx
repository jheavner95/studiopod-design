...
import { GRID_PROMOTION_CANDIDATES, GRID_CLEAN_FINDINGS } from "./_data/promotion-candidates";
  ...
  return (
    <PageShell background={<SystemGrid />}>
      <SectionShell spacing="xl">
        <PageIntro
          eyebrow="package · application components · data grid"
          title="Data grid"
          description="The canonical StudioPOD data grid — the first Operational Component built on top of the certified Foundation Layer. Composes Foundation Table, Foundation Layout, Foundation Metadata, Foundation Forms, Foundation Feedback, and Foundation Navigation end to end rather than duplicating any of their functionality. Built in DS-2.5.1; not yet adopted by any real screen."
        >
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Badge tone="warning" size="sm" className="w-fit">
              Production Ready — DS-2.5.1
            </Badge>
          </div>
          <div className="pt-2">
            <CrossLinks />
