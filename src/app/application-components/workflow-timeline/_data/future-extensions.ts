...
export const TIMELINE_FUTURE_EXTENSIONS: TimelineFutureExtension[] = [
  ...
  { title: "Diff mode", description: "Comparing two points in a workflow's history side by side (what changed between event A and event B) — deferred until a real screen needs it." },
  ...
  { title: "AI summaries", description: "Auto-generating a plain-language summary of a long or complex timeline (\"3 approvals, 1 retry, completed in 2 days\") rather than a viewer reading every event — deferred pending real usage, the same stance Workflow Stepper's own future-extensions already took on AI-guided workflows." },
];
