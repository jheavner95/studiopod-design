  ...
  return (
    <PageShell background={<SystemGrid />}>
      <SectionShell spacing="xl">
        <PageIntro
          eyebrow="package · application components · product platform"
          title="Product platform components"
          description="The canonical Product Platform Component Library — the third Platform-tier library, built entirely on Foundation, Operational, and Workflow. All 12 components are pure re-exports of already-certified lower-tier components; this package implements zero Product business logic of its own. Built in DS-4.3, the third package of the Platform Component Library."
        >
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Badge tone="warning" size="sm" className="w-fit">
              Platform Ready — DS-4.3
            </Badge>
          </div>
          <div className="pt-2">
            <CrossLinks />
