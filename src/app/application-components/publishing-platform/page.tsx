      ...
      <SectionShell spacing="lg" divider>
        <div className="flex flex-col gap-10">
          <SectionHeader
            ...
            title="When to use"
            description="What each of these 12 components owns, and where the boundary sits with the Workflow, Operational, and Pipeline components they compose — plus what stays Business Feature logic (a real provider connection, a job scheduler, a gate decision) rather than something this platform decides."
            descriptionMaxWidth={false}
          />
      ...
      <SectionShell spacing="lg" divider>
        <div className="flex flex-col gap-10">
          <SectionHeader
            ...
            title="Behavior"
            description="Eight states this platform recognizes — three of them, Draft, Published, and Archived, have no match in any existing status vocabulary, the same disclosed gap Product Platform Components already found for the identical state names — plus how the workspace adapts across breakpoints."
            descriptionMaxWidth={false}
          />
      ...
      <SectionShell spacing="lg" divider>
        <div className="flex flex-col gap-10">
          <SectionHeader
            ...
            title="Composition"
            description="Three ways this family leans on the systems underneath it instead of reimplementing them — sidebar collapse, inspector empty-state, and queue scaling."
            descriptionMaxWidth={false}
          />
        ...
        <div className="flex flex-col gap-14">
          ...
          <div className="flex flex-col gap-10">
            <SectionHeader
              ...
              description="Real, grep-verified findings across the seven subdomains this platform covers — Publishing platform, Publishing targets, Providers, Queue, History, Validation, Operations — not estimated or carried over from memory."
              descriptionMaxWidth={false}
            />
            {PUBLISHING_PROMOTION_CANDIDATES.length === 0 ? (
              <Card className="flex flex-col gap-2 border-success/30 bg-success-soft">
                <span className="text-body-sm font-medium text-ink-primary">No real implementation found to migrate</span>
                <Body size="sm" muted>
