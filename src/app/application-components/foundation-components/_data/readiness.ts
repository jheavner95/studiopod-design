...
/**
 * The four component groups this catalog directly blocks, none of which are
...
export const FOUNDATION_BLOCKERS: FoundationBlocker[] = [
  {
    id: "ds-2-2",
    targetPackage: "Asset Components",
  ...
  {
    id: "ds-2-3",
    targetPackage: "Inspector Components",
  ...
  {
    id: "ds-2-4",
    targetPackage: "Workflow Components",
  ...
  {
    id: "ds-2-5",
    targetPackage: "Operational Components",
