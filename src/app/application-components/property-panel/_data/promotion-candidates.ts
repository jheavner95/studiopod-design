...
export const PROPERTY_CLEAN_FINDINGS: string[] = [
  ...
  "One stale data note found in passing: the DS-0.2 inventory (inventory.ts) still lists \"Property Editor\" as status: \"Needed\", even though src/components/form/PropertyEditor.tsx already exists and is demonstrated live — not corrected here, since this package's own catalog entry (not the frozen DS-0.2 inventory snapshot) is the live record other packages already treat as authoritative.",
];
