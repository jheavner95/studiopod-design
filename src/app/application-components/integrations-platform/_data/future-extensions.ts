...
export const INTEGRATIONS_FUTURE_EXTENSIONS: IntegrationsFutureExtension[] = [
  ...
  { title: "Integration analytics", description: "Trend analysis and historical reporting across IntegrationsDiagnostics' own issue list and IntegrationsSync's own sync history — belongs to the Intelligence platform's own template, not this one; deferred here rather than duplicated." },
