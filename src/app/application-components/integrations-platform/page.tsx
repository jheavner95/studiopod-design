...
function CrossLinks() {
  const links = [
    ...
    { label: "Admin Platform", href: "/application-components/admin-platform" },
    ...
    { label: "Capability Library", href: "/capabilities" },
  ];
  return (
  ...
  return (
    <PageShell background={<SystemGrid />}>
      <SectionShell spacing="xl">
        <PageIntro
          eyebrow="package · application components · integrations platform"
          title="Integrations platform components"
          description="The canonical Integrations Platform Component Library — the ninth and final Platform-tier library, built entirely on Foundation, Operational, and Workflow. All 12 components are pure re-exports of already-certified lower-tier components; this package implements zero integration business logic of its own. Built in DS-4.9, the ninth and final package of the Platform Component Library — completing all eight platforms DS-4.1's own architecture named."
        >
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Badge tone="warning" size="sm" className="w-fit">
              Platform Ready — DS-4.9
            </Badge>
          </div>
          <div className="pt-2">
            <CrossLinks />
