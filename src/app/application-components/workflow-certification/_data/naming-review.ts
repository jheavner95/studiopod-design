...
export const NAMING_COLLISIONS: NamingEntry[] = [
  ...
  },
  {
    ...
    detail: "Not previously flagged in this system's own migration notes or docs — found during this audit. Import-path-distinct, so no compile-time collision, but a real discoverability cost for a future contributor searching by name alone.",
  },
  {
  ...
  },
  {
    ...
    verdict: "Real gap found this audit",
    detail: "Not previously flagged in this system's own migration notes or clean-findings data, despite the same audit rigor being applied to the PipelineStep collision above. A component name colliding with an unrelated type name in a different module — no compile-time risk, but an undocumented gap in an otherwise thoroughly-audited system.",
  },
  {
