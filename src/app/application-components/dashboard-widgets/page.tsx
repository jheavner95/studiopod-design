...
function CrossLinks() {
  const links = [
    ...
    { label: "Filter & Search System", href: "/application-components/filter-search" },
  ];
  return (
  ...
  return (
    <PageShell background={<SystemGrid />}>
      <SectionShell spacing="xl">
        <PageIntro
          eyebrow="package · application components · dashboard widgets"
          title="Dashboard widgets"
          description="The canonical StudioPOD Dashboard Widget System — the standard dashboard framework for every platform, built entirely from certified Foundation and Operational component libraries. Composes Foundation Layout/Metadata/Feedback end to end, and Operational Data Grid, Status & Health, Queue & Job, and Filter & Search directly, rather than duplicating any of them. Built in DS-2.5.9; not yet adopted by any real screen."
        >
          <div className="flex flex-wrap items-center gap-4 pt-2">
            <Badge tone="warning" size="sm" className="w-fit">
              Production Ready — DS-2.5.9
            </Badge>
          </div>
          <div className="pt-2">
            <CrossLinks />
