...
export const DASHBOARD_FUTURE_EXTENSIONS: DashboardFutureExtension[] = [
  { title: "Resizable widgets", description: "Letting a caller drag a widget's own boundary rather than accepting whatever track auto-fit gives it — deferred until a real screen needs manual sizing over DashboardGrid's own reflow." },
  ...
  { title: "Shared dashboards", description: "A dashboard arrangement one user configures becoming visible to a team — depends on Saved Dashboards existing first." },
  ...
  { title: "AI-generated dashboards", description: "Assembling a widget arrangement automatically from a stated goal rather than a screen hand-composing DashboardSection/DashboardGrid itself — deferred pending real usage." },
];
