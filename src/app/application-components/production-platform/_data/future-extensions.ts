...
export const PRODUCTION_FUTURE_EXTENSIONS: ProductionFutureExtension[] = [
  ...
  { title: "AI orchestration", description: "Real generation-job triggering and monitoring for the \"AI Generation\" gallery pattern this package only demos visually today — this audit confirmed no real AI-generation integration exists anywhere in the repo (see Migration Notes in Reference), so this is genuinely greenfield, deferred pending real usage." },
  ...
  { title: "Production analytics", description: "Trend analysis and historical reporting across many production runs — belongs to the Intelligence platform template defined on the Platform Architecture page, not this one; deferred here rather than duplicated." },
];
