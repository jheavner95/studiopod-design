...
export const CERTIFICATION_LEVELS: CertificationLevel[] = [
  {
    ...
    exitCriteria: "A dedicated duplication audit (mirroring the migration-notes review every Workflow system already went through) finds zero unjustified reimplementation of Foundation/Operational/Workflow, and a dependency review confirms zero Platform Rules violations.",
  },
  {
    id: "production-ready",
    ...
    exitCriteria: "A per-platform review, scored across a fixed set of quality dimensions, finds no outright Fail on any dimension, with named, tracked Partials acceptable.",
  },
  {
    id: "certified",
    name: "Certified",
    ...
    exitCriteria: "Independently re-audited against the same fixed set of quality dimensions, rather than trusting each component's own docs page.",
  },
  {
...
export const CERTIFICATION_MODEL_NOTE =
  "This is the governing certification ladder for every Platform component, consistent with the model Foundation and Workflow are certified against. Every one of the eight named platforms clears at least Platform Ready against exactly this ladder.";
