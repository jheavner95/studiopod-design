...
export const BULK_CLEAN_FINDINGS: string[] = [
  ...
  "DS-0.2 inventory (inventory.ts, both the application-components and foundation-audit copies): zero \"bulk\" mentions in either file — no pre-existing Exists/Partial/Needed note to reconcile, this is genuinely new capability tracked nowhere before this package.",
];
