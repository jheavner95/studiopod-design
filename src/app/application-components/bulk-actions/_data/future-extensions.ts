...
export const BULK_FUTURE_EXTENSIONS: BulkFutureExtension[] = [
  ...
  { title: "Retry failed items", description: "A per-row or bulk retry action directly from BulkConflictList. Not currently supported — today's flow is to see the reason and go fix it manually." },
  ...
  { title: "AI-assisted bulk actions", description: "Suggesting a bulk action based on the current selection (\"these 12 all look unpublished — archive them?\"). Not currently supported — this design-system layer has no access to the usage data it would need." },
