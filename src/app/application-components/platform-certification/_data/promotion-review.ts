...
export const RESOLVED: PromotionEntry[] = [
  ...
  },
  {
    ...
    detail: "page.tsx and the Foundation catalog entry both called Admin \"the first Platform package with two genuine, disclosed vocabulary gaps.\" False: Commerce Platform, three packages earlier, already disclosed exactly two (Draft, Archived), and Product Platform disclosed four. Fixed at this certification: both files now correctly note the count without the false ordinal claim.",
  },
  {
