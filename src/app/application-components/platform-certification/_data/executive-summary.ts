...
export const EXECUTIVE_SUMMARY_STRENGTHS = [
  ...
  "Five real documentation defects were found across the tier during this certification — and every one was corrected in the same pass, not left as a standing gap. This is a stronger outcome than the Workflow tier's own \"Production Ready, held back by tracked unresolved gaps\" result one tier down.",
