...
export const METADATA_ACCESSIBILITY_TOPICS: MetadataAccessibilityTopic[] = [
  ...
  { label: "Long values", text: "MetadataValue wraps (min-w-0 break-words) rather than truncating by default — the same CSS Grid blowout fix first diagnosed in DS-0.3, applied here at the atom level." },
