...
export const METADATA_FUTURE_EXTENSIONS: MetadataFutureExtension[] = [
  ...
  { title: "Expandable sections", description: "A PropertySection that collapses by default for a long property list — deferred for the same reason Panel's own Collapsible extension is deferred." },
