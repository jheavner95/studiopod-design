...
export const METADATA_COMPONENTS: MetadataComponentDoc[] = [
  {
    ...
    whenNotToUse: "Three or more related rows — use DescriptionList so screen readers get real list semantics instead of a stack of unrelated divs.",
    accessibility: "Not a semantic list on its own — reach for DescriptionList once there's more than one row to associate.",
