...
export function PlaybackSection() {
  ...
  return (
    <PreviewSection
      ...
      description="The same workflow data, advanced automatically or scrubbed by hand. WorkflowDiagram, WorkflowProgress, and WorkflowMiniMap all stay in sync because they all read from the same playedWorkflow value."
    >
