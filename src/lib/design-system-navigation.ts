 ...
 * each with its own layout treatment (see PageTypeBadge and each page's
 * own section-order convention): Landing (visual hub, entry points),
 * Reference (examples + API, the default for a component library page),
 * Pattern (composition diagrams, reusable templates), Architecture
 * (relationships and composition rules, no live examples), Certification
 * (scorecards, findings, quality gates).
 */
...
export interface NavEntry {
  ...
  description: string;
  status: NavStatus;
  /** Which of the five DS-6.1 page archetypes this page is — drives layout treatment, not just labeling. */
...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  { id: "foundation-audit", title: "Foundation Audit", href: "/application-components/foundation-audit", section: "application-components", group: "foundation-systems", order: 9, description: "The capstone audit certifying the whole Foundation layer.", status: "certified", pageType: "certification", previous: "foundation-feedback", next: "docs-operational", related: ["workspace-certification", "operational-certification", "workflow-certification", "platform-certification", "application-composition-certification"] },
  ...
  { id: "operational-certification", title: "Operational Certification", href: "/application-components/operational-certification", section: "application-components", group: "operational-systems", order: 10, description: "The capstone certifying all nine Operational systems Production Ready.", status: "certified", pageType: "certification", previous: "dashboard-widgets", next: "docs-workflow", related: ["workspace-certification", "foundation-audit", "workflow-certification", "platform-certification", "application-composition-certification"] },
  ...
  { id: "platform-certification", title: "Platform Certification", href: "/application-components/platform-certification", section: "application-components", group: "platform-systems", order: 10, description: "The capstone certifying all eight Platform libraries (96 components) Certified.", status: "certified", pageType: "certification", previous: "integrations-platform", next: "docs-certification", related: ["workspace-certification", "foundation-audit", "operational-certification", "workflow-certification", "application-composition-certification"] },

  // ---------------------------------------------------------------------
  // Application Components — 4.6 Certification (cross-cutting rollup)
  // ---------------------------------------------------------------------
  { id: "docs-certification", title: "Certification", href: "/docs/certification", section: "application-components", group: "certification", order: 0, description: "The six capstone certification and audit reviews, one per tier — Workspace, Foundation, Operational, Workflow, Platform, and Application Composition.", status: "established", pageType: "landing", previous: "platform-certification", related: ["workspace-certification", "foundation-audit", "operational-certification", "workflow-certification", "platform-certification", "application-composition-certification"] },
  ...
  { id: "application-composition-certification", title: "Application Composition Certification", href: "/docs/application-composition-certification", section: "documentation", group: "documentation", order: 5, description: "The capstone — re-auditing the Application Composition architecture, framework, and templates against their own real source, resolving two real defects, and certifying the whole Application Composition tier.", status: "certified", pageType: "certification", previous: "business-feature-templates", related: ["application-composition", "business-features", "business-feature-templates", "production-workspace-feature", "platform-certification"] },
];
