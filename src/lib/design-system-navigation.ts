...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { id: "business-features", section: "applications", title: "Business Features", href: "/application-components/business-features/production-workspace", description: "Real feature pilots composing only existing components with local state and mock data." },
...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  { id: "production-workspace-feature", title: "Production Workspace", href: "/application-components/business-features/production-workspace", section: "applications", group: "business-features", order: 0, description: "See a real example feature, a Production Workspace, built entirely from the design system's existing components to show how the pieces work together in practice.", badge: "application", pageType: "reference", previous: "integrations-platform", related: ["templates", "business-feature-templates", "application-composition-doc"] },
