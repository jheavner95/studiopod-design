...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  { id: "platforms-library", title: "Platform Architecture Library (Archived)", href: "/platforms", section: "playground", group: "legacy-experiments", order: 0, description: "A historical reference version of the platform architecture diagrams — see the Applications section for the current version.", status: "legacy", pageType: "pattern", related: ["platform-architecture-doc"], aliases: ["Distinct from /application-components/platform-architecture ('Platform Architecture') — disambiguated with an (Archived) suffix per DS-7.2's Naming Review"] },
  { id: "production-library", title: "Production & Validation Library (Archived)", href: "/production", section: "playground", group: "legacy-experiments", order: 1, description: "A historical reference version of the production and validation diagrams — see the Applications section for the current version.", status: "legacy", pageType: "pattern", related: ["production-platform"], aliases: ["Distinct from /application-components/production-platform ('Production') — disambiguated with an (Archived) suffix per DS-7.2's Naming Review"] },
  { id: "capabilities-library", title: "Capability Library (Archived)", href: "/capabilities", section: "playground", group: "legacy-experiments", order: 2, description: "A historical reference version of the capability and provider diagrams — see the Applications section for the current version.", status: "legacy", pageType: "pattern", related: ["integrations-platform"] },
