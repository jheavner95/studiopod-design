...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  // ---------------------------------------------------------------------
  { id: "foundation-table", title: "Table", href: "/application-components/foundation-table", section: "components", group: "data-display", order: 0, description: "Use this table system to display, sort, and interact with large sets of tabular data, including columns that stay pinned while scrolling.", badge: "component", pageType: "reference", next: "foundation-metadata" },
  ...
  { id: "data-grid", title: "Data Grid", href: "/application-components/data-grid", section: "components", group: "data-display", order: 2, description: "Use the data grid to show large datasets that people can sort, filter, and select rows from.", badge: "component", pageType: "reference", previous: "foundation-metadata", next: "asset-browser" },
  ...
  // Components — Forms
  // ---------------------------------------------------------------------
  { id: "foundation-forms", title: "Forms", href: "/application-components/foundation-forms", section: "components", group: "forms", order: 0, description: "Browse the form fields and input controls you can use to collect and validate information from people.", badge: "component", pageType: "reference" },
  ...
  // Applications
  // ---------------------------------------------------------------------
  { id: "applications", title: "Applications", href: "/applications", section: "applications", group: "applications-overview", order: 0, description: "Browse real, working examples of StudioPOD's domain platforms to see how certified components come together into full application screens and features.", pageType: "landing", next: "production-platform" },
