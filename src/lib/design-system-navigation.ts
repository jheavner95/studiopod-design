...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  // ---------------------------------------------------------------------
  { id: "docs-certification", title: "Certification", href: "/docs/certification", section: "application-components", group: "certification", order: 0, description: "The eight capstone certification and audit reviews — Workspace, Foundation, Operational, Workflow, Platform, and Application Composition, one per tier, Accessibility & Interaction Quality, the cross-cutting audit spanning Foundation and Operational, and the Enterprise Architecture & Adoption Audit, the final architectural review before DS-6.5 Final Enterprise Certification.", status: "established", pageType: "landing", previous: "platform-certification", next: "accessibility-certification", related: ["workspace-certification", "foundation-audit", "operational-certification", "workflow-certification", "platform-certification", "application-composition-certification", "accessibility-certification", "enterprise-architecture-audit"] },
  ...
  { id: "application-composition-certification", title: "Application Composition Certification", href: "/docs/application-composition-certification", section: "documentation", group: "documentation", order: 5, description: "The capstone — re-auditing the Application Composition architecture, framework, and templates against their own real source, resolving two real defects, and certifying the whole Application Composition tier.", status: "certified", pageType: "certification", previous: "business-feature-templates", related: ["application-composition", "business-features", "business-feature-templates", "production-workspace-feature", "platform-certification", "accessibility-certification", "enterprise-architecture-audit"] },
];
