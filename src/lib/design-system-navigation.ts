...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  // ---------------------------------------------------------------------
  { id: "platforms-library", title: "Platform Architecture Library (legacy)", href: "/platforms", section: "application-components", group: "diagram-libraries", order: 1, description: "The pre-DS-4 illustration-canvas Platform Architecture playground — diagram data, not real components.", status: "legacy", related: ["platform-architecture"], aliases: ["Same-name collision with /application-components/platform-architecture — see this package's own Naming Review"] },
  { id: "production-library", title: "Production & Validation Library (legacy)", href: "/production", section: "application-components", group: "diagram-libraries", order: 2, description: "The pre-DS-4 illustration-canvas production/validation playground — diagram data, not real components.", status: "legacy", related: ["production-platform"], aliases: ["Same-name collision with /application-components/production-platform — see this package's own Naming Review"] },
  { id: "capabilities-library", title: "Capability Library (legacy)", href: "/capabilities", section: "application-components", group: "diagram-libraries", order: 3, description: "The pre-DS-4 illustration-canvas capability/provider playground — diagram data, not real components.", status: "legacy", related: ["integrations-platform"] },
