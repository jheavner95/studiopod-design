...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  { id: "foundation-audit", title: "Foundation Audit", href: "/application-components/foundation-audit", section: "application-components", group: "foundation-systems", order: 9, description: "The DS-2.1.6 capstone auditing the whole Foundation layer.", status: "certified", previous: "foundation-feedback", next: "docs-operational", related: ["workspace-certification", "operational-certification", "workflow-certification", "platform-certification", "application-composition-certification"] },
  ...
  { id: "operational-certification", title: "Operational Certification", href: "/application-components/operational-certification", section: "application-components", group: "operational-systems", order: 10, description: "The DS-2.5.10 capstone certifying all nine Operational systems Production Ready.", status: "certified", previous: "dashboard-widgets", next: "docs-workflow", related: ["workspace-certification", "foundation-audit", "workflow-certification", "platform-certification", "application-composition-certification"] },
  ...
  { id: "platform-certification", title: "Platform Certification", href: "/application-components/platform-certification", section: "application-components", group: "platform-systems", order: 10, description: "The DS-4.10 capstone certifying all eight Platform libraries (96 components) Certified.", status: "certified", previous: "integrations-platform", next: "docs-certification", related: ["workspace-certification", "foundation-audit", "operational-certification", "workflow-certification", "application-composition-certification"] },

  // ---------------------------------------------------------------------
  // Application Components — 4.6 Certification (cross-cutting rollup)
  // ---------------------------------------------------------------------
  { id: "docs-certification", title: "Certification", href: "/docs/certification", section: "application-components", group: "certification", order: 0, description: "The six capstone certification and audit reviews, one per tier — Workspace, Foundation, Operational, Workflow, Platform, and Application Composition.", status: "established", previous: "platform-certification", related: ["workspace-certification", "foundation-audit", "operational-certification", "workflow-certification", "platform-certification", "application-composition-certification"] },
  ...
  { id: "business-feature-templates", title: "Business Feature Templates", href: "/docs/business-feature-templates", section: "documentation", group: "documentation", order: 4, description: "The DS-5.3 catalog of reusable feature blueprints — standard layouts and a composition matrix for eight of DS-5.2's nine Feature Categories.", status: "established", previous: "business-features", next: "application-composition-certification", related: ["platform-architecture", "platform-certification"] },
  { id: "application-composition-certification", title: "Application Composition Certification", href: "/docs/application-composition-certification", section: "documentation", group: "documentation", order: 5, description: "The DS-5.5 capstone — re-auditing DS-5.1–5.4 against their own real source, resolving two real defects, and certifying the whole Application Composition tier.", status: "certified", previous: "business-feature-templates", related: ["application-composition", "business-features", "business-feature-templates", "production-workspace-feature", "platform-certification"] },
];
