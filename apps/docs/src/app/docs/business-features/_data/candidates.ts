...
export const CANDIDATE_SUMMARY =
  "All ten candidates and their underlying findings come from Application Composition Architecture — this page adds a suggested Feature Category to each, nothing more. Five (Production, Product, Publishing, Commerce, Intelligence Workspace) are Platform-certified and category-obvious: Workspace Feature. Administration maps to Management Feature; Settings maps to the renamed Configuration Feature; Automation maps to the new Automation Feature category, grounded in Operations Platform's own partial OperationsAutomation coverage. Planning and Creative have no Platform-tier coverage at all, per Application Composition Architecture's own finding; Workspace Feature is suggested as their category since a Platform-tier component library would need to exist first.";
