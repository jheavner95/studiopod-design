...
import type { PlaybackSpeed } from "@jheavner95/design";
...
/**
 * The one real control surface for the workflow playground. Speed, pause,
 * replay, and reduced motion write to the MS-2.1 MotionProvider; the dev
 * overlay toggles write to the MS-2.2 IllustrationDevProvider. Every
 * workflow diagram on the page responds to both at once.
 */
