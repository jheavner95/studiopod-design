...
export const APPROVAL_CLEAN_FINDINGS: string[] = [
  ...
  "Planning: no src/planning/ directory or component exists anywhere in the repo, confirmed independently by this check and an earlier audit of the same area — nothing to check for duplication.",
