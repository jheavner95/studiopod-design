...
export const WORKFLOW_FUTURE_EXTENSIONS: WorkflowFutureExtension[] = [
  { title: "Parallel stages", description: "WorkflowStageGroup already lays stages side by side, but nothing yet models two stages genuinely running at once with independent completion." },
  ...
  { title: "Workflow simulation", description: "Running a workflow definition against synthetic data to preview timing and bottlenecks before committing it to production is not supported." },
  { title: "AI workflow generation", description: "Assembling a stage/step arrangement automatically from a stated goal rather than a screen hand-composing Workflow/WorkflowStage/WorkflowStep itself is not supported." },
];
