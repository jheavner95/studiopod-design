...
export const FOUNDATION_DESIGN_RULES: DesignRule[] = [
  ...
  },
  {
    ...
    explanation: "The moment a second operational component needs the same pattern a first one already built, that pattern graduates out of its own component and into this catalog, so both consumers share one implementation instead of two.",
  },
];
