...
/** Decisions a caller makes before reaching for Asset Browser — which view, and how search/filter/sort are wired up. */
...
/** How Asset Browser composes with the state and components a caller already owns. */
