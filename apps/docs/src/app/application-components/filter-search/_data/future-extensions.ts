...
export const SEARCH_FUTURE_EXTENSIONS: SearchFutureExtension[] = [
  { title: "AI Search", description: "A conversational search box that interprets an open-ended request rather than matching literal text. Not currently supported; SearchField's plain text contract doesn't preclude swapping the matching engine behind it later." },
  { title: "Semantic Search", description: "Matching by meaning/embedding similarity rather than substring. Not currently supported — this family's SearchField contract (value/onChange, a query string) doesn't change, only what runs behind onChange would." },
  { title: "Natural Language Filters", description: "Parsing \"published this week\" into a structured FilterGroup selection automatically. Not currently supported — matching rules against real usage haven't been proven out yet." },
