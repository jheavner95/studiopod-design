...
export const WORKFLOW_VIZ_CLEAN_FINDINGS: string[] = [
  ...
  "Planning, Automation: no src/planning/ or src/automation/ directory exists anywhere in the repo — reconfirmed via a full directory search, consistent with every prior Workflow Component Library audit.",
