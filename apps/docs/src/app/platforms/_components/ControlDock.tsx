...
/**
 * The one real control surface for the platform architecture playground.
 * Speed, pause, replay, and reduced motion write to the MS-2.1
 * MotionProvider; the dev overlay toggles write to the MS-2.2
 * IllustrationDevProvider. Every diagram on the page responds to both.
 */
