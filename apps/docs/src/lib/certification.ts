...
export const CERTIFICATION_REGISTRY: ComponentCertificationRecord[] = [
  {
    ...
    sourcePath: "packages/design/src/components/ui/Button.tsx",
    level: "Certified",
    completedChecks: [
      "identity-related",
      "api-type-safe",
  ...
  },
  {
    ...
    sourcePath: "packages/design/src/components/layout/Workspace.tsx",
  ...
  },
  {
    ...
    sourcePath: "packages/design/src/components/layout/SplitView.tsx",
    level: "Production Ready",
    completedChecks: [
      "identity-related",
      "api-type-safe",
