...
export const NAV_REGISTRY: NavEntry[] = [
  ...
  // Components — Layout
  // ---------------------------------------------------------------------
  { id: "foundation-layout", title: "Layout", href: "/application-components/foundation-layout", section: "components", group: "layout", order: 0, description: "Use these layout primitives to arrange and space content consistently across a page or screen.", badge: "foundation", pageType: "reference", next: "foundation-workspace", related: ["foundation-workspace", "foundation-splitview", "foundation-components", "foundation-table", "foundation-metadata"] },
  { id: "foundation-workspace", title: "Workspace", href: "/application-components/foundation-workspace", section: "components", group: "layout", order: 1, description: "Use the Workspace primitive to build the full-bleed application shell a tool lives in — header, toolbar, navigation, content, inspector, and status regions, composed from real components, not configured.", badge: "foundation", pageType: "reference", previous: "foundation-layout", next: "foundation-splitview", related: ["foundation-layout", "docs-workspace", "workspace-framework", "foundation-splitview"], aliases: ["Distinct from Workspace Shell (/docs/workspace, the architecture concept) and Workspace Framework (/application-components/workspace-framework, the shell's layering rules) — this page documents the reusable src/components/layout/Workspace.tsx primitive itself."] },
  { id: "foundation-splitview", title: "SplitView", href: "/application-components/foundation-splitview", section: "components", group: "layout", order: 2, description: "Use the SplitView primitive to divide a Workspace region into independently resizable, scrollable panes — drag, touch, and keyboard resizing, with a clean split between Workspace's page structure and SplitView's pane composition.", badge: "foundation", pageType: "reference", previous: "foundation-workspace", related: ["foundation-layout", "foundation-workspace", "workspace-framework"], aliases: ["The reusable src/components/layout/SplitView.tsx primitive — SplitPane and SplitDivider are composed inside it, not documented as separate catalog entries."] },
