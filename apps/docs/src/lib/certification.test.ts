...
describe("pilot: Button — automated certification checks", () => {
  ...
  it("has a certification record", () => {
    ...
    expect(button.sourcePath).toBe("packages/design/src/components/ui/Button.tsx");
  });
...
describe("pilot: Workspace — automated certification checks", () => {
  ...
  it("has a certification record", () => {
    ...
    expect(workspace.sourcePath).toBe("packages/design/src/components/layout/Workspace.tsx");
  });
...
describe("pilot: SplitView — automated certification checks", () => {
  ...
  it("has a certification record", () => {
    ...
    expect(splitView.sourcePath).toBe("packages/design/src/components/layout/SplitView.tsx");
  });
