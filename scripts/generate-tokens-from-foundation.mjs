 ...
 *
 * Usage:
 *   node scripts/generate-tokens-from-foundation.mjs           # write
 *   node scripts/generate-tokens-from-foundation.mjs --check   # verify, exit 1 on drift
 */
...
const banner = (file) =>
  ...
  ` * Source of names  : this file's generator, scripts/generate-tokens-from-foundation.mjs\n` +
