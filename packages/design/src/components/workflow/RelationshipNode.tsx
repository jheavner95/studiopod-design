...
export { DependencyNode as RelationshipNode, DependencyNodeMarker as RelationshipNodeMarker, type DependencyStatusValue as RelationshipStatusValue,
  type DependencyNodeProps as RelationshipNodeProps,
} from "./DependencyNode";
