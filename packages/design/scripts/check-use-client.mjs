 ...
 *
 * internal.js is included for the same reason as of DH-2: it exports the
 * motion engine and the illustration dev context provider.
 *
...
const REQUIRED_ENTRIES = ["index.js", "marketing.js", "illustrations.js", "internal.js"];
