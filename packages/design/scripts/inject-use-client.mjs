 ...
 * internal (the motion engine, the illustration dev overlay) is a client
 * entry too — added in DH-2.
 *
...
const CLIENT_ENTRIES = ["index.js", "marketing.js", "illustrations.js", "internal.js"];
