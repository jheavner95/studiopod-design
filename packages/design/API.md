...
**No application may import it.** See `docs/decisions/0011-internal-entry-point.md`.

The platform demo components that used to live at `src/components/platform/**` are not exported from any entry point and, as of DH-2, are not in this package at all — they are documentation-site compositions and live in `apps/docs/src/components/platform/`.
