...
Output goes to `packages/design/dist/`. Nothing here modifies the repo's own documentation app or its build.

## Local pack

```bash
npm run package:pack     # npm pack ./packages/design → a .tgz in packages/design/
