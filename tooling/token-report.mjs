...
const TOKEN_SOURCE_FILES = [
  "packages/design/src/styles/palette.css",
  "packages/design/src/styles/theme.css",
  "packages/design/src/styles/tokens.css",
  "apps/docs/src/app/globals.css",
];
const UNUSED_SCAN_SOURCE_FILES = TOKEN_SOURCE_FILES.filter((f) => f !== "packages/design/src/styles/palette.css");
const SCAN_DIRS = ["packages/design/src", "apps/docs/src", "apps/docs/e2e"];
