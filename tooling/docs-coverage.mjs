...
const navSource = readFileSync(join(repoRoot, "apps/docs/src/lib/design-system-navigation.ts"), "utf8");
...
console.log(`page.tsx files:   ${countPageFiles(join(repoRoot, "apps/docs/src/app"))}  (1 intentionally unregistered — see design-system-navigation.test.ts)\n`);
...
const FAMILIES = [
  "packages/design/src/components/operational",
  "packages/design/src/components/workflow",
  "packages/design/src/components/ui",
  "packages/design/src/components/form",
  "packages/design/src/components/layout",
  "packages/design/src/components/feedback",
  "packages/design/src/components/metadata",
  "packages/design/src/components/navigation",
  "packages/design/src/components/table",
  "apps/docs/src/components/docs",
  "packages/design/src/components/overlay",
  "packages/design/src/motion",
  "packages/design/src/illustrations",
];
